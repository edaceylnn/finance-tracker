...
> = {
  ...
  'Maaş':            { icon: 'briefcase',       bg: '#E8F5E9', color: '#2E7D32' },
  Freelance:         { icon: 'laptop-outline',  bg: '#E3F2FD', color: '#1565C0' },
  'Kira Geliri':     { icon: 'home',            bg: '#F3E5F5', color: '#7B1FA2' },
  'Yatırım Getirisi':{ icon: 'trending-up',     bg: '#E0F7FA', color: '#00838F' },
  'Diğer Gelir':     { icon: 'wallet-outline',  bg: '#FFF9C4', color: '#F57F17' },
  Diğer: { icon: 'ellipsis-horizontal-circle',  bg: '#ECEFF1', color: '#546E7A' },
};
